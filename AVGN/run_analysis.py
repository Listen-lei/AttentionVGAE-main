...
from utils import read_10X_Visium, read_SlideSeq, read_stereoSeq, refine
from imge import ImageFeature, image_crop
from process import graph, combine_graph_dict
from avgn_model import AVGN_model
from trainF import Train
from ext import augment_adata
...
class RunAnalysis:
    ...
    def _get_image_crop(
        ...
        adata = ImageFeature(adata, pca_components=pca_n_comps, cnn_type=cnnType).extract_image_feat()
        return adata
    ...
    def _fit(
        ...
        AVGN_train.fit()
        emb, _ = AVGN_train.process()
        print("Step 3: Train has been Done!")
